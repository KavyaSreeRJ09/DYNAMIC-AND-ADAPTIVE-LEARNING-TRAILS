...
// Array to hold questions for each topic
...
function loadQuestions() {
    ...
    switch(selectedTopic) {
        case "machine-learning":
            selectedQuestions = machineLearningQuestions;
            break;
        case "dynamic-programming":
            selectedQuestions = dynamicProgrammingQuestions;
            break;
        case "data-structures":
            selectedQuestions = dataStructuresQuestions;
            break;
        case "web-technology":
            selectedQuestions = webTechnologyQuestions;
            break;
        case "python":
...
function showQuestions(index){
    ...
    // Add event listeners to all available options
